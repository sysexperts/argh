-- Partner Console Tabellen für sys-experts.de
...
-- Mandanten-Lizenzen (welche Module hat welcher Mandant)
CREATE TABLE IF NOT EXISTS bm_tenant_licenses (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- Deployment Versionen (welche Version läuft wo)
CREATE TABLE IF NOT EXISTS bm_tenant_versions (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    tenant_id INTEGER NOT NULL,
...
-- Heartbeat/Monitoring (Status der Kundeninstanzen)
CREATE TABLE IF NOT EXISTS bm_tenant_heartbeats (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    tenant_id INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS bm_releases (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
-- Mandanten-Notizen (für Support/Admin)
CREATE TABLE IF NOT EXISTS bm_tenant_notes (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    tenant_id INTEGER NOT NULL,
