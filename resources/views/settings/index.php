...
<form method="POST" action="/settings/update">
    ...
    <div id="content-company" class="tab-content">
        <div class="bg-card-light dark:bg-card-dark rounded-lg shadow-sm p-6 mb-6">
            <h3 class="text-lg font-semibold text-text-light dark:text-text-dark mb-4">Firmeninformationen</h3>
    ...
    <div id="content-tax" class="tab-content hidden">
        <div class="bg-card-light dark:bg-card-dark rounded-lg shadow-sm p-6 mb-6">
            <h3 class="text-lg font-semibold text-text-light dark:text-text-dark mb-4">Steuerinformationen</h3>
        ...
        <div class="bg-card-light dark:bg-card-dark rounded-lg shadow-sm p-6 mb-6">
            <h3 class="text-lg font-semibold text-text-light dark:text-text-dark mb-4">Bankverbindung</h3>
    ...
    <div id="content-invoice" class="tab-content hidden">
        <div class="bg-card-light dark:bg-card-dark rounded-lg shadow-sm p-6 mb-6">
            <h3 class="text-lg font-semibold text-text-light dark:text-text-dark mb-4">Rechnungseinstellungen</h3>
    ...
    <div id="content-updates" class="tab-content hidden">
        ...
        <div class="bg-gradient-to-r from-primary/10 to-teal-500/10 border border-primary/20 rounded-lg p-6 mb-6">
    ...
    <div id="content-email" class="tab-content hidden">
        <div class="bg-card-light dark:bg-card-dark rounded-lg shadow-sm p-6 mb-6">
            <h3 class="text-lg font-semibold text-text-light dark:text-text-dark mb-4">E-Mail Einstellungen</h3>
